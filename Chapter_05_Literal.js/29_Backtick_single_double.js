// Single & Double Quotes: Same behavior, no multiline, no interpolation.
// Backticks: Support multiline strings and string interpolation via ${}.
...
console.log(backtick); // "backtick single"
